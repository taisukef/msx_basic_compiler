...
std::map< CMNEMONIC_TYPE, CCOMMAND_TYPE > command_list = {
	...
	{ CMNEMONIC_TYPE::BIT,		  { 2, "BIT" } },
	{ CMNEMONIC_TYPE::RES,		  { 2, "RES" } },
	{ CMNEMONIC_TYPE::SET,		  { 2, "SET" } },
	...
	{ CMNEMONIC_TYPE::RLA,        { 0, "RLA" } },
	{ CMNEMONIC_TYPE::RRA,        { 0, "RRA" } },
...
std::map< std::string, CMNEMONIC_TYPE > command_name_list = {
	...
	{ "RLA",		CMNEMONIC_TYPE::RLA },
	{ "RRA",		CMNEMONIC_TYPE::RRA },
